...
for code in range(0, 16):
   ...
   # print(f"{code:3d}: {r:02X} {g:02X} {b:02X}")
    print(f'{code:3d}:\033[38:5:{code}m :{r:02X} {g:02X} {b:02X}\033[0m')
...
for code in range(0, 16):
    ...
    b = 127 if code == 8 else 238 if code == 4 else level if (code & 4) != 0 else 0
   # print(f"{code:3d}: {r:02X} {g:02X} {b:02X}")
    print(f'{code:3d}:\033[48:5:{code}m :{r:02X} {g:02X} {b:02X}\033[0m')
...
for gray in range(0, 24):
    ...
    print(f'{code:3d}:\033[38:5:{code}m :{level:02X} {level:02X} {level:02X}\033[0m')
...
for gray in range(0, 24):
    ...
    code = 232 + gray
    #print(f"{code:3d}: {level:02X} {level:02X} {level:02X}")
    print(f'{code:3d}:\033[48:5:{code}m :{level:02X} {level:02X} {level:02X}\033[0m')
